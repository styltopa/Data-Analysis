...
fprintf('Paramatric vs non parametric (bootstrap) method\n');
% b0
fprintf('- b0\n');
fprintf('Real beta0 value: %.3f + %.3f\n', beta0 -scaleDownVal, scaleDownVal);
fprintf('%.2f%% bootstrap ci: [%.3f, %.3f] + %.3f\n', ...
     (1-alpha)*100, b0BootCILow-scaleDownVal, b0BootCIHigh-scaleDownVal,...
     scaleDownVal);


fprintf('%.2f%% parametric ci: [%.3f, %.3f] + %.3f\n\n', ...
     (1-alpha)*100, b0ParametricCILow-scaleDownVal, ...
     b0ParametricCIHigh-scaleDownVal, scaleDownVal);

% b1
fprintf('- b1\n');
fprintf('Real beta1 value: %.3f \n', beta1);
fprintf('%.2f%% bootstrap ci: [%.3f, %.3f] \n', ...
     (1-alpha)*100, b1BootCILow, b1BootCIHigh);

fprintf('%.2f%% parametric ci: [%.3f, %.3f]\n\n', ...
     (1-alpha)*100, b1ParametricCILow, ...
     b1ParametricCIHigh);
